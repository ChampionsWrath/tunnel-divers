...
import { clamp, lsGet, lsSet, uid, mulberry32, PLAYER_COLORS } from './util.js?v=39';
import * as audio from './audio.js?v=39';
import { getInput, attachTouch, clearTouch, ctl, setCtl, askTiltPerm, calibrateTilt, tiltStatus, setTiltOrient, getTiltOrient } from './input.js?v=39';
import { Net, makeRoomCode } from './net.js?v=39';
import tunnel from './games/tunnel.js?v=39';
import stack from './games/stack.js?v=39';
import crown from './games/crown.js?v=39';
import brain from './games/brain.js?v=39';
import blast from './games/blast.js?v=39';
import food from './games/food.js?v=39';
import homerun from './games/homerun.js?v=39';
import trivia from './games/trivia.js?v=39';
import ghost from './games/ghost.js?v=39';
import greed from './games/greed.js?v=39';
import lava from './games/lava.js?v=39';
import rush from './games/rush.js?v=39';
import carousel from './games/carousel.js?v=39';
import { createBoard } from './board.js?v=39';
import { drawDiverStand, WARDROBE, migrateWard, DEF_HAIR_COL, DEF_FACE_COL } from './character.js?v=39';
...
const BUILD = 39;   // bump with ?v= — shown on the home screen so mismatched phones are obvious
